    ...
    return (
        <footer className="bg-light pt-4">
                    ...
                    <Col lg={6}>
                        <Row>
                            ...
                            <Col md={6}>
                                ...
                                <ul>
                                    {[
                                        {Icon: AiFillHome, text: "Ladhudhuwa,Galle,Sri Lanka"},
                                        {Icon: FaEnvelope, text: "info@hellofashion.com"},
                                        {Icon: FaPhoneAlt, text: "+ 94 70 16 52 768"},
                                    ].map(({Icon, text}) => (
            ...
            <div className="text-center p-3 bg-light mt-3">
                © All Rights Reserved. Developed by <a href="http://prageethmilan.epizy.com/" target={"_blank"}>Danushi</a>.
            </div>
        </footer>
    );
}
